...
function generateCerts (){
	CRYPTOGEN=/home/ubuntu/work/src/github.com/hyperledger/fabric/build/bin/cryptogen
...
function generateChannelArtifacts() {
	...
	CONFIGTXGEN=/home/ubuntu/work/src/github.com/hyperledger/fabric/build/bin/configtxgen
	...
	echo "#################################################################"
	$CONFIGTXGEN -profile TwoOrgsChannel -outputCreateChannelTx ./channel-artifacts/KaiserClsStlmt.tx -channelID $CHANNEL_NAME
